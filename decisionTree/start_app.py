"""Run the Decision Tree teaching page on a local address."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the Decision Tree teaching app.")
    parser.add_argument("--port", type=int, default=8002, help="First local port to try.")
    ...
    print("Decision Tree ER Lab is ready.")
